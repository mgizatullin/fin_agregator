    ...
    <div class="space-y-6">
        <x-filament::section>
            ...
            <p class="text-gray-600 dark:text-gray-400 mb-4">
                Загрузите CSV с разделителем «;» или «,». Заголовки можно на русском: Название (банк), Регион, Город, Адрес, Телефон, Время работы, Широта, Долгота — или на английском (bank, region, city, …). Далее: «Распознать», «Проверить», «Импортировать».
                Город и регион сопоставляются с базой без учёта регистра, с приведением «ё» к «е» и лишних пробелов; в отделение сохраняется регион из справочника городов.
            </p>
            {{ $this->form }}
        </x-filament::section>
