    ...
    <div class="space-y-6">
        <x-filament::section>
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">
                Вставьте JSON-массив с займами, затем нажмите «Распознать», чтобы проверить структуру и получить краткий отчёт.
                После этого можно выполнить импорт в раздел займов.
            </p>
                            ...
                            <tr>
                                ...
                                <td class="py-3 pr-4 align-top">
                                    ...
                                    <div class="text-xs text-gray-500 dark:text-gray-400">
                                        slug: {{ \Illuminate\Support\Str::slug($item['lookup']['name'] ?? '') ?: '—' }}
                                    </div>
                                </td>
                                <td class="py-3 pr-4 align-top">
                                    @if($item['ready'] ?? false)
