<x-filament-panels::page>
    <div class="space-y-6">
        <x-filament::section>
            <x-slot name="heading">
                Парсер кредитов Myfin
            </x-slot>
            <p class="text-gray-600 dark:text-gray-400 mb-4">
                Парсер читает общий каталог кредитов Myfin и выводит результат только в JSON. Если сервер не может открыть `ru.myfin.by`,
                можно вставить HTML каталога вручную и распарсить его без сетевого доступа.
            </p>
            {{ $this->form }}
        </x-filament::section>
